...
export default {
  ...
  methods: {
    ...
    updateProduct() {
      this.$emit('close', [2, true]);
      this.$emit('close', [3, false]);
    },
    async deleteProduct() {
      try {
        await axios
    ...
    <div class="form">
        <header>
            ...
            <div class="product__btns">
                ...
                <button
                    @click="closeForm"
                    class="btn close_btn" id="close_btn">
        ...
        <div class="info">
            <table>
                ...
                <tr>
                    <th>Аттрибуты</th>
                    <td>
                      <div class="attributes" v-for="(value, attribute) in JSON.parse(product.data)"
                           :key="attribute">
                        {{ attribute }}: {{ value }}
                      </div>
                    </td>
